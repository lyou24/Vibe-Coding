...
def test_seed_execution_and_user_10605_opi():
    ...
    - total_opi が約 1426.7（1420.0 〜 1435.0）に収まること
    """
    ...
    assert 1420.0 <= total_opi <= 1435.0, f"total_opi ({total_opi}) が期待値（約1426.7）から乖離しています"
    assert abs(total_opi - 1426.66) < 0.5, f"total_opi ({total_opi}) が 1426.66 から外れています"
